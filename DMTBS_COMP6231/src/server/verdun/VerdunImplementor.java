...
import server.verdun.data.MovieDetails;
import server.verdun.threads.UDPClient;

public class VerdunImplementor extends UnicastRemoteObject implements CustomerInterface, AdminInterface {

	protected VerdunImplementor() throws RemoteException {
		super();
	}
	...
	public String getBookingSchedule(String customerID) throws RemoteException {
		...
		String verCus = Data.constructCustomerMovieSchedule(customerID);
		System.out.println(verCus);

		JSONObject verSchJSON = new JSONObject(verCus);
