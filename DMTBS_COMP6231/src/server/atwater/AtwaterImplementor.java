...
import server.atwater.data.Data;
import server.atwater.data.MovieDetails;
import server.atwater.threads.UDPClient;




public class AtwaterImplementor extends UnicastRemoteObject implements CustomerInterface, AdminInterface {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1211160529384422814L;
	protected String serverInitials = "ATW";
	protected AtwaterImplementor() throws RemoteException {
		super();
...
//		logger.log(Level.INFO, JSONObject.valueToString(collection));
	...
	public String getBookingSchedule(String customerID) throws RemoteException {
		...
		String atwCus = Data.constructCustomerMovieSchedule(customerID);
		JSONObject atwSchJSON = new JSONObject (atwCus);
		...
		UDPClient outCus = new UDPClient(customerID, method, "OUT");
		...
		System.out.println("outremont customer"+ outCus.getValue());

		JSONObject verSchJSON = new JSONObject(verCus.getValue());
		JSONObject outSchJSON = new JSONObject(outCus.getValue());
